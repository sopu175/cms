...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'categories' AND policyname = 'Admins can manage all categories') THEN
  ...
  -- Posts policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'posts' AND policyname = 'Public can read published posts') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'posts' AND policyname = 'Authenticated users can read all posts') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'posts' AND policyname = 'Editors and admins can manage all posts') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'content_pages' AND policyname = 'Anyone can read published content pages') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'content_pages' AND policyname = 'Authors can manage own content pages') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'content_pages' AND policyname = 'Editors and admins can manage all content pages') THEN
  ...
  -- Sections policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'sections' AND policyname = 'Anyone can read sections of published pages') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'sections' AND policyname = 'Authors can manage sections of own pages') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'sections' AND policyname = 'Editors and admins can manage all sections') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'products' AND policyname = 'Editors and admins can manage products') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'product_variations' AND policyname = 'Anyone can read active product variations') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'product_variations' AND policyname = 'Editors and admins can manage product variations') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'orders' AND policyname = 'Users can update own pending orders') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'orders' AND policyname = 'Admins and editors can manage all orders') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'order_items' AND policyname = 'Users can create order items for own orders') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'order_items' AND policyname = 'Admins and editors can manage all order items') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'settings' AND policyname = 'Only admins can manage settings') THEN
  ...
  -- Site info policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'site_info' AND policyname = 'Anyone can read site info') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'site_info' AND policyname = 'Only admins can manage site info') THEN
  ...
  -- Wishlists policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'wishlists' AND policyname = 'Users can manage own wishlists') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'reviews' AND policyname = 'Users can update own pending reviews') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'reviews' AND policyname = 'Admins and editors can manage all reviews') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'coupons' AND policyname = 'Only admins can manage coupons') THEN
  ...
  -- Media policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'media' AND policyname = 'Anyone can read media') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'media' AND policyname = 'Users can manage own media') THEN
  ...
  -- Menus policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'menus' AND policyname = 'Anyone can read active menus') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'menus' AND policyname = 'Authenticated users can manage menus') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'forms' AND policyname = 'Authenticated users can manage forms') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'form_submissions' AND policyname = 'Users can submit forms') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'form_submissions' AND policyname = 'Users can read own submissions') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'form_submissions' AND policyname = 'Authenticated users can manage all submissions') THEN
  ...
  -- SEO meta policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'seo_meta' AND policyname = 'Anyone can read seo meta') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'seo_meta' AND policyname = 'Authenticated users can manage seo meta') THEN
