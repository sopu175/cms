/*
  # Update site_info table for enhanced contact and social media

  1. Changes
    - Add new columns to site_info table
    - Add contact_info and social_icons fields
    - Update existing site_info structure
  2. Security
